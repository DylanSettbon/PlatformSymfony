 ...
 */
final class Version20181128182744 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ALTER created_at SET DEFAULT \'1\'');
        $this->addSql('ALTER TABLE comment ALTER updated_at SET DEFAULT \'1\'');
        ...
        $this->addSql('ALTER TABLE feature ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'1\' NOT NULL');
        $this->addSql('ALTER TABLE feature ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'1\' NOT NULL');
